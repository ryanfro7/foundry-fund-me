...
This is the first piece of Solidity code I've worked with as part of the Cyfrin Updraft Solidity Course.
...
I learned about 4 test tiers in the video. 
...
This repo covers #1 and #3. (I haven't covered #2 or #4 yet, maybe I'll revisit this project to add in those capabilities as I learn more) 
...
Thanks to Patrick Collins for creating a free resource that teaches solidity in an non-intimidating way!
